...
/**
 * Tests for {@link com.hawkw.queuelab.ArrayQueue}.
 * 
 * @author Hawk Weisman
 */
...
public class TestArrayQueue {
	...
	public void basicEnqueueDequeueTest() {
		try {
			intTestQueue = new ArrayQueue<Integer>();
			intTestQueue.enqueue(1);
			intTestQueue.enqueue(2);
			intTestQueue.enqueue(3);

			org.junit.Assert.assertSame("BAD: ArrayQueue dequeued wrong item",
			...
			stringTestQueue = new ArrayQueue<String>();
			stringTestQueue.enqueue("Alice");
			stringTestQueue.enqueue("Bob");
			stringTestQueue.enqueue("Charlie");

			org.junit.Assert.assertSame("BAD: ArrayQueue dequeued wrong item",
					"Alice", stringTestQueue.dequeue());
			org.junit.Assert.assertSame("BAD: ArrayQueue dequeued wrong item",
					"Bob", stringTestQueue.dequeue());
			org.junit.Assert.assertSame("BAD: ArrayQueue dequeued wrong item",
					"Charlie", stringTestQueue.dequeue());
		} catch (Exception e) {
			e.printStackTrace(System.err);
			fail("Threw an unexpected error.");
		}
	}
	...
	/**
	 * tests to see if FullQueueExceptions are thrown when expected
	 * 
	 * @throws FullQueueException
	 */
	@Test
	public void basicFullQueueExceptionTest() throws FullQueueException {
		thrown.expect(FullQueueException.class);
		intTestQueue = new ArrayQueue<Integer>(2);
		intTestQueue.enqueue(1);
		intTestQueue.enqueue(2);
		intTestQueue.enqueue(3);
	}
